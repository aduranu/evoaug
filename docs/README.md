...
This directory contains the source files for the EvoAug documentation, built using Sphinx and hosted on Read the Docs.
...
- **Project URL**: https://evoaug.readthedocs.io/
- **Build Status**: [![Documentation Status](https://readthedocs.org/projects/evoaug/badge/?version=latest)](https://evoaug.readthedocs.io/en/latest/?badge=latest)
...
- Open an issue on the [GitHub repository](https://github.com/p-koo/evoaug)
...
The documentation is licensed under the same terms as the EvoAug package (MIT License). 