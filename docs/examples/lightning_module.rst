...
This example demonstrates a complete EvoAug training workflow using PyTorch Lightning, implementing the two-stage training approach with comprehensive checkpoint management and performance evaluation.
...
1. **RobustLoader Integration**: Uses EvoAug's RobustLoader for efficient augmentation management
...
.. code-block:: python
   ...
   from evoaug.model_zoo import YourCustomModel
...
This example provides a production-ready template for implementing EvoAug in PyTorch Lightning workflows and can serve as a foundation for your own genomic sequence analysis projects. 