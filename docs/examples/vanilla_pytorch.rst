...
This example demonstrates basic EvoAug functionality using vanilla PyTorch, providing a simple and direct approach to integrating evolution-inspired augmentations into your training pipeline.
...
- **Core EvoAug functionality** demonstration
...
This example provides a solid foundation for understanding EvoAug's core functionality and can be easily extended for your specific research needs. 