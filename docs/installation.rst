...
EvoAug can be installed via pip from PyPI or directly from the GitHub repository. The package requires Python 3.8 or higher and PyTorch 1.9.0 or higher.

Installation from PyPI
----------------------

The recommended way to install EvoAug is through PyPI:
...
EvoAug provides several optional dependency groups for different use cases:

**Full installation (recommended for most users):**

.. code-block:: bash

   pip install evoaug[full]
...
After installation, verify that EvoAug is working correctly:
...
.. code-block:: python
   ...
   print("EvoAug installation successful!")
...
2. **Permission Errors:**
   ...
   - Or use ``pip install --user evoaug`` for user installation
...
- Check the `GitHub Issues <https://github.com/p-koo/evoaug/issues>`_ page
