...
EvoAug provides comprehensive examples demonstrating different integration approaches and use cases. These examples range from basic PyTorch integration to advanced PyTorch Lightning workflows.
...
.. code-block:: bash
   ...
   python -c "from evoaug import utils; utils.download_deepstarr_data()"
...
- Consult the `GitHub Issues <https://github.com/p-koo/evoaug/issues>`_ page
...
The examples provide a solid foundation for understanding EvoAug's capabilities and can be easily adapted for your specific use cases. 