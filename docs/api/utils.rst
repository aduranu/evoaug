EvoAug API Reference
=====================

This page provides comprehensive API documentation for the EvoAug package.

Package Overview
---------------

The EvoAug package consists of several core modules:

- **`evoaug.augment`**: Core augmentation classes for genomic sequences
- **`evoaug.loader`**: Main training utilities and RobustLoader
- **`evoaug.model_zoo`**: Pre-built model architectures
- **`evoaug.utils`**: Utility functions for data handling and evaluation
...
The `evoaug.loader` module provides training utilities:

**RobustLoader:**

.. autoclass:: evoaug.RobustLoader
   :members:
   :undoc-members:
   :show-inheritance:
...
.. autofunction:: evoaug.loader.train_with_augmentations

.. autofunction:: evoaug.loader.finetune_model

Model Architectures
------------------

The `evoaug.model_zoo` module provides pre-built architectures:

**DeepSTARR Models:**

.. autoclass:: evoaug.model_zoo.DeepSTARR
   :members:
   :undoc-members:
   :show-inheritance:

.. autoclass:: evoaug.model_zoo.DeepSTARRModel
   :members:
   :undoc-members:
   :show-inheritance:
...
.. autoclass:: evoaug.model_zoo.Basset
   :members:
   :undoc-members:
   :show-inheritance:
...
.. autoclass:: evoaug.model_zoo.CNN
   :members:
   :undoc-members:
   :show-inheritance:
...
The `evoaug.utils` module provides helper functions:

**Data Handling:**

.. autofunction:: evoaug.utils.H5Dataset
   :noindex:

.. autoclass:: evoaug.utils.H5DataModule
   :members:
   :undoc-members:
   :show-inheritance:
...
.. autofunction:: evoaug.utils.evaluate_model

.. autofunction:: evoaug.utils.get_predictions

.. autofunction:: evoaug.utils.calculate_auroc

.. autofunction:: evoaug.utils.calculate_aupr

.. autofunction:: evoaug.utils.calculate_mse

.. autofunction:: evoaug.utils.calculate_pearsonr

.. autofunction:: evoaug.utils.calculate_spearmanr

**Training Support:**

.. autofunction:: evoaug.utils.configure_optimizer

.. autofunction:: evoaug.utils.get_fmaps

.. autofunction:: evoaug.utils.make_directory
...
.. code-block:: python
   ...
   from evoaug.model_zoo import DeepSTARR, DeepSTARRModel
