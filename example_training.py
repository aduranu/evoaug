...
def main():
    ...
    print("")
    print("Augmentation Methodology:")
    print("  - Each sequence is randomly augmented independently for each mini-batch")
    print("  - Hard augmentation setting: always apply exactly 2 augmentations per sequence")
    print("  - Augmentations are sampled randomly without replacement from the defined set")
    print("  - Priority order: inversion, deletion, translocation, insertion, reverse-complement, mutation, noise")
    print("  - Each augmentation is applied stochastically for each sequence")
    print("  - Hyperparameters optimized for DeepSTARR through validation set hyperparameter search")
    print("  - Note: Insertion augmentation automatically pads sequences at 3' end with random DNA of length insert_max")
    print("    This padding is maintained during evaluation to ensure consistent sequence lengths")
