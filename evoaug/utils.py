...
"""
Utility functions and data loading classes for EvoAug.

This module provides H5-backed datasets, evaluation metrics, and other
...
class H5Dataset(Dataset):
    ...
    methods of a Lightning DataModule, making it easy to integrate with EvoAug
