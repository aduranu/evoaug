"""
Reference model architectures and PyTorch Lightning wrappers.

Provides the DeepSTARR architecture (and a Lightning wrapper around it),
Basset, and a generic CNN — useful as drop-in baselines when
demonstrating EvoAug augmentations.
"""
